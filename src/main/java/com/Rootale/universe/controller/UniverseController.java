...
public class UniverseController {
    ...
    @PostMapping
    @Operation(summary = "새로운 세계관 생성", description = "새로운 세계관을 생성합니다, represntative_img에 key값-> presigned url 반환")
    @ApiResponses({
    ...
    @PatchMapping("/{universe_id}")
    @Operation(summary = "세계관 수정", description = "세계관 정보를 수정합니다")
    @ApiResponses({
