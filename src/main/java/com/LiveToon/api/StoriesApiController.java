...
@Controller
@RequestMapping("${openapi.liveTale.base-path:/v1}")
public class StoriesApiController implements StoriesApi {

    private final NativeWebRequest request;

    @Autowired
    public StoriesApiController(NativeWebRequest request) {
