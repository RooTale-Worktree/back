...
/**
 * UserSettingsPatchRequestStoryPreferences
 */

@JsonTypeName("_user_settings_patch_request_story_preferences")
...
public class UserSettingsPatchRequestStoryPreferences {
  ...
  public UserSettingsPatchRequestStoryPreferences autoSave(@Nullable Boolean autoSave) {
  ...
  @Schema(name = "auto_save", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  public UserSettingsPatchRequestStoryPreferences imageQuality(@Nullable ImageQualityEnum imageQuality) {
  ...
  @Schema(name = "image_quality", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  public boolean equals(Object o) {
    ...
    UserSettingsPatchRequestStoryPreferences userSettingsPatchRequestStoryPreferences = (UserSettingsPatchRequestStoryPreferences) o;
    return Objects.equals(this.autoSave, userSettingsPatchRequestStoryPreferences.autoSave) &&
        Objects.equals(this.imageQuality, userSettingsPatchRequestStoryPreferences.imageQuality);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserSettingsPatchRequestStoryPreferences {\n");
