...
/**
 * UserSettingsPatchRequestPrivacy
 */

@JsonTypeName("_user_settings_patch_request_privacy")
...
public class UserSettingsPatchRequestPrivacy {
  ...
  public UserSettingsPatchRequestPrivacy profileVisibility(@Nullable ProfileVisibilityEnum profileVisibility) {
  ...
  @Schema(name = "profile_visibility", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  public UserSettingsPatchRequestPrivacy storySharing(@Nullable Boolean storySharing) {
  ...
  @Schema(name = "story_sharing", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  public boolean equals(Object o) {
    ...
    UserSettingsPatchRequestPrivacy userSettingsPatchRequestPrivacy = (UserSettingsPatchRequestPrivacy) o;
    return Objects.equals(this.profileVisibility, userSettingsPatchRequestPrivacy.profileVisibility) &&
        Objects.equals(this.storySharing, userSettingsPatchRequestPrivacy.storySharing);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserSettingsPatchRequestPrivacy {\n");
